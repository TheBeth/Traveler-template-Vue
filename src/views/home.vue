<template>
  <div class="home-container">
    <section class="home-hero">
      ...
      <div id="features" class="home-feaures">
    ...
    <section id="tours" class="home-quick-view">
      ...
      <div class="home-offers">
        <router-link to="/">
          <div class="home-offer-container">
            <app-offer Image="/playground_assets/offers-11-1500w.png"></app-offer>
          </div>
        </router-link>
        <router-link to="/">
      ...
      <div class="home-pagination">
        ...
        <div class="home-pages">
          ...
          <img alt="image" src="/playground_assets/more.svg" class="home-more" />
    ...
    <section id="guides" class="home-guides">
      ...
      <div class="home-list1">
        <router-link to="/">
          <div class="home-guide-wrapper"><app-guide></app-guide></div>
        </router-link>
        <router-link to="/">
    ...
    <section class="home-faq">
      <div id="faqs" class="home-content06">
        ...
        <div class="home-accordion">
          <div data-role="accordion-container" class="accordion home-element">
          ...
          <div data-role="accordion-container" class="home-element4 accordion">
            <div class="home-content11">
              <span class="home-header12">Incididunt ut labore et dolore?</span>
    ...
    <section class="home-footer">
      <div class="home-content12">
        ...
        <span class="home-copyright">© 2022 Character. All Rights Reserved.</span>
      </div>
    </section>
    <div>
      <DangerousHTML
...
import AppOffer from '../components/offer'
